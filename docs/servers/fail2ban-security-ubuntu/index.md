...
Para contrarrestar el impacto de un escenario como el anterior, hoy vamos a instalar, configurar y aprender a usar una herramienta clásica en la industria llamada _fail2ban_, que se encarga de monitorear constantemente los logs del sistema en busca de patrones de intentos fallidos de conexión, entre otros y aplicar reglas al firewall, con el fin de "encarcelar" las direcciones IP de donde provienen esos ataques o directamente "bloquear" conexiones entrantes según las reglas que hayamos establecido.
