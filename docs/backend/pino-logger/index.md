...
Un **log** se puede traducir un **registro** o una **traza** que se deja en algún medio, puede ser un mensaje en archivo de texto, una entrada en una base de datos, etc. El objetivo del logging (la acción de registrar) es mostrar mensajes que ayudan a entender que ocurre mientras un software ejecuta sus tareas.
...
### Logging Format y Correlation ID
...
### Inyectar Pino en la Aplicación
